...
Functions in this script call a PHP proxy called action.php that should have one method call:
...
function changeChannel(deviceId, channelId) {
    link = 'action.php?action=watch&deviceId=' + deviceId + '&channelId=' + channelId;
...
function setPosition(deviceId, position) {
    link = 'action.php?action=scrub&deviceId=' + deviceId + '&position=' + position;
...
function addToPlanner(deviceId, scheduleId, channelId, channelNumber, channelName, dateTime, duration) {
    link = 'action.php?action=record&deviceId=' + deviceId + '&scheduleId=' + scheduleId + '&channelId=' + channelId + '&channelNumber=' + channelNumber + '&channelName=' + channelName + '&dateTime=' + dateTime + '&duration=' + duration;
...
function playPlannerItem(deviceId, plannerId) {
    link = 'action.php?action=play&deviceId=' + deviceId + '&plannerId=' + plannerId;
...
function pause(deviceId) {
    link = 'action.php?action=pause&deviceId=' + deviceId;
...
function resume(deviceId) {
    link = 'action.php?action=resume&deviceId=' + deviceId;
...
function speed(deviceId, speed) {
    link = 'action.php?action=speed&deviceId=' + deviceId + '&speed=' + speed;
...
function stop(deviceId) {
    link = 'action.php?action=stop&deviceId=' + deviceId;
...
function changePlannerItemKeep(deviceId, plannerId, keep) {
    link = 'action.php?action=keep&deviceId=' + deviceId + '&plannerId=' + plannerId + '&keep=' + keep;
...
function deleteFromPlanner(deviceId, plannerId) {
    link = 'action.php?action=delete&deviceId=' + deviceId + '&plannerId=' + plannerId;
...
function longpoll() {
	if (longpollUrl) {
	    link = 'action.php?action=longpoll&url=' + longpollUrl;
	    if (etag) {
	        link += '&etag=' + etag;
	    }
	    if (lastModified) {
...
function unsubscribe() {
	if (shouldUnsubscribe) {
	    link = 'action.php?action=unsubscribe&url=' + unsubscribeUrl;
