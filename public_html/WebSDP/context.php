...
head('Context', "onload=\"incrementPosition(); longpoll();\" onunload=\"unsubscribe();\"");
echo($sdp->subscribeScript());
navbar('context');

function controlButton($link, $image, $id) {
	return "<td align=\"center\">" . javascriptLink($link, "<img id=\"$id\" src=\"images/$image.png\" width=\"30\" height=\"30\">") . "</td>";
}
